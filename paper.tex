...
\author{\IEEEauthorblockN{Jiri Hamberg\IEEEauthorrefmark{1}}
...
\markboth{Network Measurement Seminar,~2016}%
...
Here stuff about the metrics of measurements.

\section{Methodology}
Here stuff about the different methodologies that can be applied to measuring TCP.
...
\subsection{Evaluation of Congestion Control Algorithms}
